...
namespace Cosolem
{
    public partial class frmIndicesComerciales : Form
    {
        ...
        private void frmIndicesComerciales_Load(object sender, EventArgs e)
        {
        ...
        private void CargarProductos()
        {
            ...
            ((Modelo)cmbModelo.SelectedItem).tbProducto.Where(x => x.estadoRegistro).ToList().ForEach(x =>
            {
                ...
                if (_tbIndiceComercial != null)
                {
                    ...
                    x.fechaHasta = _tbIndiceComercial.fechaHasta;
                }
        ...
        private void tsbGrabar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (_BindingListtbProducto.Where(x => x.fechaHasta.Date < Program.fechaHora.Date).Any()) mensaje += "Indice comercial con fecha de vigencia menor a la fecha actual\n";
